︠24f78f3b-f0cb-48e1-82ad-9bf5cd68efbfs︠
...
print 'j_data=',data_j
#print 'zz_data=', data_zzfrom scipy.special import jv, legendre, sph_harm, jacobi
︡eee87198-a984-4e75-9fa3-b22949559fd2︡{"stdout":"j_data="}︡{"stderr":"Error in lines 121-121\nTraceback (most recent call last):\n  File \"/cocalc/lib/python2.7/site-packages/smc_sagews/sage_server.py\", line 1043, in execute\n    exec compile(block+'\\n', '', 'single', flags=compile_flags) in namespace, locals\n  File \"\", line 1, in <module>\nNameError: name 'data_j' is not defined\n"}︡{"done":true}︡
︠b22e9b24-96f4-46a6-b92a-bbfdba073db2︠
︡3e3ce5f5-9136-406d-86fb-de47e162fd50︡
︠ec4bc1e8-8282-447a-9dbf-cbad42163f2c︠
